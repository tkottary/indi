...
LX200AstroPhysicsExperimental::LX200AstroPhysicsExperimental() : LX200Generic()
{
    ...
    SetMountCapability(GetMountCapability() | MOUNT_HAS_PIER_SIDE | MOUNT_HAS_PEC | MOUNT_CAN_CONTROL_TRACK | MOUNT_HAS_TRACK_RATE, 4);
...
bool LX200AstroPhysicsExperimental::initializeMount()
{
...
void LX200AstroPhysicsExperimental::syncSideOfPier()
{
    ...
    if (!strcmp(response, "East"))
        setPierSide(INDI::Mount::PIER_EAST);
    else if (!strcmp(response, "West"))
        setPierSide(INDI::Mount::PIER_WEST);
    else
...
bool LX200AstroPhysicsExperimental::MoveNS(INDI_DIR_NS dir, MountMotionCommand command)
{
...
bool LX200AstroPhysicsExperimental::MoveWE(INDI_DIR_WE dir, MountMotionCommand command)
{
