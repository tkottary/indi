...
bool SkywatcherAltAzSimple::initProperties()
{
    ...
    IUFillSwitchVector(&WedgeModeSP, WedgeMode, 3, getDeviceName(), "MOUNT_MOTION_WEDGEMODE",
    ...
    IUFillSwitchVector(&TrackLogModeSP, TrackLogMode, 2, getDeviceName(), "MOUNT_MOTION_TRACKLOGMODE",
...
bool SkywatcherAltAzSimple::MoveNS(INDI_DIR_NS dir, MountMotionCommand command)
{
...
bool SkywatcherAltAzSimple::MoveWE(INDI_DIR_WE dir, MountMotionCommand command)
{
...
bool SkywatcherAltAzSimple::Sync(double ra, double dec)
{
    ...
    // Stop any movements
    if (TrackState != MOUNT_IDLE && TrackState != MOUNT_PARKED)
    {
        Abort();
    }
