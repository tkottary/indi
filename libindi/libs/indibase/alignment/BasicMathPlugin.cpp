...
bool BasicMathPlugin::Initialise(InMemoryDatabase *pInMemoryDatabase)
{
    ...
    switch (SyncPoints.size())
    {
        ...
        case 1:
        {
            ...
            MountDirectionVector ActualDirectionCosine1 =
                MountDirectionVectorFromAltitudeAzimuth(ActualSyncPoint1);
            MountDirectionVector DummyActualDirectionCosine2;
            MountDirectionVector DummyApparentDirectionCosine2;
            MountDirectionVector DummyActualDirectionCosine3;
            MountDirectionVector DummyApparentDirectionCosine3;
            ...
            switch (ApproximateMountAlignment)
            {
                ...
                case NORTH_CELESTIAL_POLE:
                {
                    ...
                    DummyActualDirectionCosine2   = MountDirectionVectorFromAltitudeAzimuth(DummyAltAz);
                    DummyApparentDirectionCosine2 = DummyActualDirectionCosine2;
                    break;
                }
            ...
            DummyApparentDirectionCosine3 = Entry1.MountDirection * DummyApparentDirectionCosine2;
            ...
            CalculateTransformMatrices(ActualDirectionCosine1, DummyActualDirectionCosine2, DummyActualDirectionCosine3,
                                       Entry1.MountDirection, DummyApparentDirectionCosine2,
        ...
        case 2:
        {
            ...
            MountDirectionVector ActualDirectionCosine1 =
                MountDirectionVectorFromAltitudeAzimuth(ActualSyncPoint1);
            MountDirectionVector ActualDirectionCosine2 =
                MountDirectionVectorFromAltitudeAzimuth(ActualSyncPoint2);
            MountDirectionVector DummyActualDirectionCosine3;
            MountDirectionVector DummyApparentDirectionCosine3;
            DummyActualDirectionCosine3 = ActualDirectionCosine1 * ActualDirectionCosine2;
            DummyActualDirectionCosine3.Normalise();
            DummyApparentDirectionCosine3 = Entry1.MountDirection * Entry2.MountDirection;
            DummyApparentDirectionCosine3.Normalise();
            ...
            CalculateTransformMatrices(ActualDirectionCosine1, ActualDirectionCosine2, DummyActualDirectionCosine3,
                                       Entry1.MountDirection, Entry2.MountDirection,
                                       DummyApparentDirectionCosine3, pActualToApparentTransform,
                                       pApparentToActualTransform);
            return true;
        }
        ...
        case 3:
        {
            ...
            MountDirectionVector ActualDirectionCosine2 =
                MountDirectionVectorFromAltitudeAzimuth(ActualSyncPoint2);
            MountDirectionVector ActualDirectionCosine3 =
                MountDirectionVectorFromAltitudeAzimuth(ActualSyncPoint3);

            CalculateTransformMatrices(ActualDirectionCosine1, ActualDirectionCosine2, ActualDirectionCosine3,
                                       Entry1.MountDirection, Entry2.MountDirection, Entry3.MountDirection,
        ...
        default:
        {
                 ...
                 Itr != SyncPoints.end(); Itr++)
            {
                ...
                MountDirectionVector ActualDirectionCosine =
                    MountDirectionVectorFromAltitudeAzimuth(ActualSyncPoint);
                ...
                ApparentConvexHull.MakeNewVertex((*Itr).MountDirection.x, (*Itr).MountDirection.y,
                                                 (*Itr).MountDirection.z, VertexNumber);
                VertexNumber++;
            }
                ...
                do
                {
                    ...
                    else
                    {
                        ...
                        CalculateTransformMatrices(ActualDirectionCosines[CurrentFace->vertex[0]->vnum - 1],
                                                   ...
                                                   SyncPoints[CurrentFace->vertex[0]->vnum - 1].MountDirection,
                                                   SyncPoints[CurrentFace->vertex[1]->vnum - 1].MountDirection,
                                                   SyncPoints[CurrentFace->vertex[2]->vnum - 1].MountDirection,
                ...
                do
                {
                    ...
                    else
                    {
                        ...
                        ASSDEBUGF("Initialise - Processing apparent face %d v1 %d v2 %d v3 %d", ApparentFaces,
                                  ...
                                  CurrentFace->vertex[2]->vnum);
#endif
                        CalculateTransformMatrices(SyncPoints[CurrentFace->vertex[0]->vnum - 1].MountDirection,
                                                   SyncPoints[CurrentFace->vertex[1]->vnum - 1].MountDirection,
                                                   SyncPoints[CurrentFace->vertex[2]->vnum - 1].MountDirection,
...
bool BasicMathPlugin::TransformCelestialToMount(const double RightAscension, const double Declination,
                                                    double JulianOffset,
                                                    MountDirectionVector &ApparentMountDirectionVector)
{
    ...
    MountDirectionVector ActualVector = MountDirectionVectorFromAltitudeAzimuth(ActualAltAz);
    ...
    switch (SyncPoints.size())
    {
        ...
        {
            // 0 sync points
            ApparentMountDirectionVector = ActualVector;
            ...
            switch (ApproximateMountAlignment)
            {
                ...
                case NORTH_CELESTIAL_POLE:
                    ...
                    ApparentMountDirectionVector.RotateAroundY(Position.lat - 90.0);
                    break;
        ...
        case 3:
        {
            ...
            ApparentMountDirectionVector.x = gsl_vector_get(pGSLApparentVector, 0);
            ApparentMountDirectionVector.y = gsl_vector_get(pGSLApparentVector, 1);
            ApparentMountDirectionVector.z = gsl_vector_get(pGSLApparentVector, 2);
            ApparentMountDirectionVector.Normalise();
        ...
        default:
        {
            ...
            MountDirectionVector ScaledActualVector = ActualVector * 2.0;
            ...
            if (nullptr != CurrentFace)
            {
                ...
                if (CurrentFace == ActualConvexHull.faces)
                {
                         ...
                         Itr != SyncPoints.end(); Itr++)
                    {
                        ...
                        MountDirectionVector ActualDirectionCosine =
                            MountDirectionVectorFromAltitudeAzimuth(ActualPoint);
                    ...
                    CalculateTransformMatrices(ActualDirectionCosine1, ActualDirectionCosine2, ActualDirectionCosine3,
                                               pEntry1->MountDirection, pEntry2->MountDirection,
                                               pEntry3->MountDirection, pComputedTransform, nullptr);
    ...
    AltitudeAzimuthFromMountDirectionVector(ApparentMountDirectionVector, ApparentAltAz);
    ASSDEBUGF("Celestial to telescope - Apparent Alt %lf Az %lf", ApparentAltAz.alt, ApparentAltAz.az);

    return true;
}

bool BasicMathPlugin::TransformMountToCelestial(const MountDirectionVector &ApparentMountDirectionVector,
                                                    double &RightAscension, double &Declination)
{
    ...
    AltitudeAzimuthFromMountDirectionVector(ApparentMountDirectionVector, ApparentAltAz);
    ASSDEBUGF("Mount to celestial - Apparent Alt %lf Az %lf", ApparentAltAz.alt, ApparentAltAz.az);
    ...
    switch (SyncPoints.size())
    {
        ...
        {
            // 0 sync points
            MountDirectionVector RotatedTDV(ApparentMountDirectionVector);
            switch (ApproximateMountAlignment)
            {
                case ZENITH:
                    break;
            ...
            ASSDEBUGF("ApparentVector x %lf y %lf z %lf", ApparentMountDirectionVector.x,
                      ApparentMountDirectionVector.y, ApparentMountDirectionVector.z);
            ASSDEBUGF("ActualVector x %lf y %lf z %lf", RotatedTDV.x, RotatedTDV.y, RotatedTDV.z);
            AltitudeAzimuthFromMountDirectionVector(RotatedTDV, ActualAltAz);
        ...
        {
            gsl_vector *pGSLApparentVector = gsl_vector_alloc(3);
            gsl_vector_set(pGSLApparentVector, 0, ApparentMountDirectionVector.x);
            gsl_vector_set(pGSLApparentVector, 1, ApparentMountDirectionVector.y);
            gsl_vector_set(pGSLApparentVector, 2, ApparentMountDirectionVector.z);
            gsl_vector *pGSLActualVector = gsl_vector_alloc(3);
            ...
            MountDirectionVector ActualMountDirectionVector;
            ActualMountDirectionVector.x = gsl_vector_get(pGSLActualVector, 0);
            ActualMountDirectionVector.y = gsl_vector_get(pGSLActualVector, 1);
            ActualMountDirectionVector.z = gsl_vector_get(pGSLActualVector, 2);
            ActualMountDirectionVector.Normalise();
            AltitudeAzimuthFromMountDirectionVector(ActualMountDirectionVector, ActualAltAz);
            ln_get_equ_from_hrz(&ActualAltAz, &Position, ln_get_julian_from_sys(), &ActualRaDec);
            // libnova works in decimal degrees so conversion is needed here
            RightAscension = ActualRaDec.ra * 24.0 / 360.0;
            Declination    = ActualRaDec.dec;
        ...
        default:
        {
            ...
            MountDirectionVector ScaledApparentVector = ApparentMountDirectionVector * 2.0;
            ...
            if (nullptr != CurrentFace)
            {
                do
                {
                    ...
                    {
#ifdef CONVEX_HULL_DEBUGGING
                        ASSDEBUGF("MountToCelestial - Processing apparent face %d v1 %d v2 %d v3 %d", ApparentFaces,
                                  CurrentFace->vertex[0]->vnum, CurrentFace->vertex[1]->vnum,
                                  CurrentFace->vertex[2]->vnum);
#endif
                ...
                if (CurrentFace == ApparentConvexHull.faces)
                {
                    ...
                    for (InMemoryDatabase::AlignmentDatabaseType::const_iterator Itr = SyncPoints.begin();
                         Itr != SyncPoints.end(); Itr++)
                    {
                        NearestMap[((*Itr).MountDirection - ApparentMountDirectionVector).Length()] = &(*Itr);
                    }
                    // First compute local horizontal coordinates for the three sync points
                    std::map<double, const AlignmentDatabaseEntry *>::const_iterator Nearest = NearestMap.begin();
                    const AlignmentDatabaseEntry *pEntry1                                    = (*Nearest).second;
                    ...
                    MountDirectionVector ActualDirectionCosine3 =
                        MountDirectionVectorFromAltitudeAzimuth(ActualSyncPoint3);
                    pComputedTransform = gsl_matrix_alloc(3, 3);
                    CalculateTransformMatrices(pEntry1->MountDirection, pEntry2->MountDirection,
                                               pEntry3->MountDirection, ActualDirectionCosine1,
    ...
    ASSDEBUGF("Mount to Celestial - Actual Alt %lf Az %lf", ActualAltAz.alt, ActualAltAz.az);
    return true;
}
...
bool BasicMathPlugin::RayTriangleIntersection(MountDirectionVector &Ray, MountDirectionVector &TriangleVertex1,
                                              MountDirectionVector &TriangleVertex2,
                                              MountDirectionVector &TriangleVertex3)
{
    // Use Möller-Trumbore

    //Find vectors for two edges sharing V1
    MountDirectionVector Edge1 = TriangleVertex2 - TriangleVertex1;
    MountDirectionVector Edge2 = TriangleVertex3 - TriangleVertex1;

    MountDirectionVector P = Ray * Edge2; // cross product
    ...
    MountDirectionVector T(-TriangleVertex1.x, -TriangleVertex1.y, -TriangleVertex1.z);
    ...
    MountDirectionVector Q = T * Edge1;
