...
private:
    ...
    void SkywatcherMicrostepsFromMountDirectionVector(
        const INDI::AlignmentSubsystem::MountDirectionVector MountDirectionVector, long &Axis1Microsteps,
        long &Axis2Microsteps);
    const INDI::AlignmentSubsystem::MountDirectionVector
    MountDirectionVectorFromSkywatcherMicrosteps(long Axis1Microsteps, long Axis2Microsteps);
