...
#include "indibase/indimount.h"
#define MYDEBUG(priority, msg) \
    INDI::Logger::getInstance().print(pChildMount->getDeviceName(), priority, __FILE__, __LINE__, msg)
#define MYDEBUGF(priority, msg, ...) \
    INDI::Logger::getInstance().print(pChildMount->getDeviceName(), priority, __FILE__, __LINE__, msg, __VA_ARGS__)
#else
#define MYDEBUG(priority, msg)
#define MYDEBUGF(priority, msg, ...)
#endif
...
#ifdef INDI_DEBUG_LOGGING
  public:
    INDI::Mount *pChildMount { nullptr };
#endif
};
